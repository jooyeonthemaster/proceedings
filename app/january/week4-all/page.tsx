...
// Part 1: 타이틀 (1 slide)
import AllTitleSlide from '@/components/january-week4-all/AllTitleSlide';

// Part 2: 개발팀 업무 공유 (2 slides)
import DevTeamTitleSlide from '@/components/january-week4-all/DevTeamTitleSlide';
import PpudukStatusSlide from '@/components/january-week4-all/PpudukStatusSlide';

// Part 3: 김제연 성과 공유 (5 slides)
import JeyeonIntroSlide from '@/components/january-week4-all/JeyeonIntroSlide';
import JeyeonProjectsSlide from '@/components/january-week4-all/JeyeonProjectsSlide';
import JeyeonPassionSlide from '@/components/january-week4-all/JeyeonPassionSlide';
import JeyeonTraitsSlide from '@/components/january-week4-all/JeyeonTraitsSlide';
import JeyeonFeedbackSlide from '@/components/january-week4-all/JeyeonFeedbackSlide';

// Part 4: 결론 (1 slide)
import AllConclusionSlide from '@/components/january-week4-all/AllConclusionSlide';
...
const sections = [
  { name: '개요', startIndex: 0, endIndex: 0, color: 'from-cyan-500 to-emerald-600' },
  { name: '개발팀', startIndex: 1, endIndex: 2, color: 'from-cyan-500 to-blue-600' },
  { name: '김제연 성과', startIndex: 3, endIndex: 7, color: 'from-purple-500 to-pink-600' },
  { name: '결론', startIndex: 8, endIndex: 8, color: 'from-emerald-500 to-cyan-600' },
];

export default function JanuaryWeek4AllPage() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">1월 4주차 (전체)</span>
            {currentSection && (
              <div
