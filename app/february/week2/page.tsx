...
import TitleSlide from '@/components/february-week2/TitleSlide';
import DeadlineStatusSlide from '@/components/february-week2/DeadlineStatusSlide';
import RemainingProjectsSlide from '@/components/february-week2/RemainingProjectsSlide';
import TopPrioritySlide from '@/components/february-week2/TopPrioritySlide';
import NetworkStrategySlide from '@/components/february-week2/NetworkStrategySlide';
import DevTeamUpdateSlide from '@/components/february-week2/DevTeamUpdateSlide';
import ConclusionSlide from '@/components/february-week2/ConclusionSlide';

const slides = [
  TitleSlide,
  DeadlineStatusSlide,
  RemainingProjectsSlide,
  TopPrioritySlide,
  NetworkStrategySlide,
  DevTeamUpdateSlide,
  ConclusionSlide,
];
...
const sections = [
  ...
  { name: '2/13 마감', startIndex: 1, endIndex: 1, color: 'from-red-500 to-orange-600' },
  { name: '남은 사업', startIndex: 2, endIndex: 2, color: 'from-emerald-500 to-teal-600' },
  { name: '긴급 과제', startIndex: 3, endIndex: 3, color: 'from-red-500 to-rose-600' },
  { name: '네트워크', startIndex: 4, endIndex: 4, color: 'from-orange-500 to-amber-600' },
  { name: '개발팀', startIndex: 5, endIndex: 5, color: 'from-cyan-500 to-blue-600' },
  { name: '결론', startIndex: 6, endIndex: 6, color: 'from-rose-500 to-pink-600' },
];

export default function FebruaryWeek2Page() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">2월 2주차</span>
            {currentSection && (
              <div
