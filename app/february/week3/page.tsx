...
import TitleSlide from '@/components/february-week3/TitleSlide';
import HackathonSlide from '@/components/february-week3/HackathonSlide';
import AICoupleServiceSlide from '@/components/february-week3/AICoupleServiceSlide';
import BusinessPipelineSlide from '@/components/february-week3/BusinessPipelineSlide';
import ContentSalesSlide from '@/components/february-week3/ContentSalesSlide';
import DevUpdatesSlide from '@/components/february-week3/DevUpdatesSlide';
import ConclusionSlide from '@/components/february-week3/ConclusionSlide';

const slides = [
  TitleSlide,
  HackathonSlide,
  AICoupleServiceSlide,
  BusinessPipelineSlide,
  ContentSalesSlide,
  DevUpdatesSlide,
  ConclusionSlide,
];
...
const sections = [
  { name: '개요', startIndex: 0, endIndex: 0, color: 'from-violet-500 to-fuchsia-600' },
  { name: '해커톤', startIndex: 1, endIndex: 1, color: 'from-amber-500 to-orange-600' },
  { name: 'AI 커플', startIndex: 2, endIndex: 2, color: 'from-pink-500 to-rose-600' },
  { name: 'B2B 파이프', startIndex: 3, endIndex: 3, color: 'from-cyan-500 to-blue-600' },
  { name: '판매 전략', startIndex: 4, endIndex: 4, color: 'from-violet-500 to-purple-600' },
  { name: '개발 현황', startIndex: 5, endIndex: 5, color: 'from-emerald-500 to-teal-600' },
  { name: '결론', startIndex: 6, endIndex: 6, color: 'from-violet-500 to-fuchsia-600' },
];

export default function FebruaryWeek3Page() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">2월 4주차</span>
            {currentSection && (
              <div
