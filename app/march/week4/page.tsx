...
import TitleSlide from '@/components/march-week4/TitleSlide';
import DevPlanSlide from '@/components/march-week4/DevPlanSlide';
import CollaborationSlide from '@/components/march-week4/CollaborationSlide';
import PpudeokUpdateSlide from '@/components/march-week4/PpudeokUpdateSlide';
import MarketingRequestSlide from '@/components/march-week4/MarketingRequestSlide';
import SalesRequestSlide from '@/components/march-week4/SalesRequestSlide';
import ConclusionSlide from '@/components/march-week4/ConclusionSlide';
...
const slides = [
  ...
  CollaborationSlide,
  PpudeokUpdateSlide,
  MarketingRequestSlide,
  SalesRequestSlide,
  ConclusionSlide,
];

const sections = [
  { name: '개요', startIndex: 0, endIndex: 0, color: 'from-emerald-500 to-cyan-600' },
  { name: '개발 계획', startIndex: 1, endIndex: 1, color: 'from-emerald-500 to-teal-600' },
  { name: '협업', startIndex: 2, endIndex: 2, color: 'from-violet-500 to-purple-600' },
  { name: '뿌덕 사이트', startIndex: 3, endIndex: 3, color: 'from-cyan-500 to-blue-600' },
  { name: '마케팅 요청', startIndex: 4, endIndex: 4, color: 'from-rose-500 to-pink-600' },
  { name: '영업 요청', startIndex: 5, endIndex: 5, color: 'from-orange-500 to-amber-600' },
  { name: '결론', startIndex: 6, endIndex: 6, color: 'from-emerald-500 to-cyan-600' },
];

export default function MarchWeek4Page() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">3월 4주차</span>
            {currentSection && (
              <div
