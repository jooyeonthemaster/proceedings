...
import TitleSlide from '@/components/march-week2/TitleSlide';
import RnDReviewSlide from '@/components/march-week2/RnDReviewSlide';
import GrantResultsSlide from '@/components/march-week2/GrantResultsSlide';
import GrantInsightsSlide from '@/components/march-week2/GrantInsightsSlide';
import DigitalWreathSlide from '@/components/march-week2/DigitalWreathSlide';
import WowLaunchSlide from '@/components/march-week2/WowLaunchSlide';
import DevTeamSlide from '@/components/march-week2/DevTeamSlide';
import ConclusionSlide from '@/components/march-week2/ConclusionSlide';
...
const sections = [
  { name: '개요', startIndex: 0, endIndex: 0, color: 'from-teal-500 to-cyan-600' },
  { name: 'R&D 후기', startIndex: 1, endIndex: 1, color: 'from-amber-500 to-orange-600' },
  { name: '지원사업 결과', startIndex: 2, endIndex: 2, color: 'from-cyan-500 to-blue-600' },
  { name: '인사이트', startIndex: 3, endIndex: 3, color: 'from-violet-500 to-purple-600' },
  { name: '화환 정산', startIndex: 4, endIndex: 4, color: 'from-emerald-500 to-teal-600' },
  { name: 'WOW 출시', startIndex: 5, endIndex: 5, color: 'from-violet-500 to-rose-600' },
  { name: '개발팀', startIndex: 6, endIndex: 6, color: 'from-cyan-500 to-emerald-600' },
  { name: '결론', startIndex: 7, endIndex: 7, color: 'from-teal-500 to-cyan-600' },
];

export default function MarchWeek2Page() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">3월 2주차</span>
            {currentSection && (
              <div
