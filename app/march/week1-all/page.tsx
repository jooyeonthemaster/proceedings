...
import TitleSlide from '@/components/march-week1-all/TitleSlide';
import RnDCelebrationSlide from '@/components/march-week1-all/RnDCelebrationSlide';
import DigitalWreathSlide from '@/components/march-week1-all/DigitalWreathSlide';
import AIEducationSlide from '@/components/march-week1-all/AIEducationSlide';
import DongseouldBidSlide from '@/components/march-week1-all/DongseouldBidSlide';
...
const sections = [
  ...
  { name: 'R&D 축하', startIndex: 1, endIndex: 1, color: 'from-yellow-500 to-amber-600' },
  { name: '디지털 화환', startIndex: 2, endIndex: 2, color: 'from-emerald-500 to-teal-600' },
  { name: 'AI 교육', startIndex: 3, endIndex: 3, color: 'from-violet-500 to-purple-600' },
  { name: '입찰', startIndex: 4, endIndex: 4, color: 'from-blue-500 to-cyan-600' },
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-dark/80 backdrop-blur-md border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-gray-500 text-sm">3월 1주차 전체</span>
            {currentSection && (
              <div
