...
import TitleSlide from '@/components/july-week4/TitleSlide';
import AgendaSlide from '@/components/july-week4/AgendaSlide';
import SmoatStallSlide from '@/components/july-week4/SmoatStallSlide';
import GoldenTimeSlide from '@/components/july-week4/GoldenTimeSlide';
import RootCauseSlide from '@/components/july-week4/RootCauseSlide';
import BoardReviewSlide from '@/components/july-week4/BoardReviewSlide';
import SeminarD3Slide from '@/components/july-week4/SeminarD3Slide';
import OwnerProposalSlide from '@/components/july-week4/OwnerProposalSlide';
import DailyStandupSlide from '@/components/july-week4/DailyStandupSlide';
import ProductStudySlide from '@/components/july-week4/ProductStudySlide';
import DecisionsSlide from '@/components/july-week4/DecisionsSlide';
import NextActionsSlide from '@/components/july-week4/NextActionsSlide';
import FinalSummarySlide from '@/components/july-week4/FinalSummarySlide';
...
const slides = [
  ...
  BoardReviewSlide,    // 5
  SeminarD3Slide,      // 6
  OwnerProposalSlide,  // 7
  DailyStandupSlide,   // 8
  ProductStudySlide,   // 9
  DecisionsSlide,      // 10
  NextActionsSlide,    // 11
  FinalSummarySlide,   // 12
];

const sections = [
  { name: '오프닝', startIndex: 0, endIndex: 1, color: 'from-rose-700 to-slate-800' },
  { name: '현주소 진단', startIndex: 2, endIndex: 4, color: 'from-rose-700 to-orange-900' },
  { name: '실행 점검', startIndex: 5, endIndex: 6, color: 'from-amber-700 to-rose-900' },
  { name: '체계 제안', startIndex: 7, endIndex: 9, color: 'from-cyan-700 to-indigo-900' },
  { name: '결정 & 마무리', startIndex: 10, endIndex: 12, color: 'from-emerald-700 to-teal-900' },
];

export default function JulyWeek4Page() {
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-md border-b border-slate-800/50">
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-slate-600 text-sm">7월 4주차 · 7/23 전체 회의</span>
            {currentSection && (
              <div
